...
c         write (8, 0705)
c         write (8, 0706) stpmin, stpmax, ftol, gtol, xtol
c         write (8, 0707)
c 0705    format (/,'START',1x,' stpmin',1x,' stpmax',1x,'   ftol',1x,
c     +            '   gtol',1x,'   xtol')
c 0706    format (5x,5(1x,d7.1))
c 0707    format (/,'stg','       f', '      fx', '      fy', '       g',
c     +            '      gx', '      gy', '     stx', '     sty',
c     +            '   ftest', '   gtest')
...
c         ftest = finit + stp*gtest
c         write (8, 0708) stage, f, fx, fy, g, gx, gy, stx, sty, 
c     +                     ftest, gtest
c
         goto 1000
...
c      write (8,0709) '--new--> stage=', stage, 'stp=', stp,
c     +          'stmin=', stmin, 'stmax=', stmax, 'task=', task
c
c 0708 format (i3,10(1x,d7.1))
c 0709 format (a15,i1,1x,a4,d7.1,1x,a6,d7.1,1x,a6,d7.1,1x,a5,a8)
