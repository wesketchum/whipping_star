...
namespace LEEana{
    ...
    std::vector<double> wireWrapperBayes(std::vector<double> &means, std::vector<double>&sigma2s, std::vector<double>& pots);
  ...
  public:
    ...
    int get_num_components(){return meas_vec.size();}; 
